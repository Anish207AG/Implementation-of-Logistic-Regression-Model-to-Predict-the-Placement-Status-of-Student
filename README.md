...
## Algorithm
1. Prepare:Load the dataset and perform one-hpt encoding on categorical features.
2. Split:Divide the features set (X) and target (Y) into training and testing subsets.
3. Train:Initialize the Logistic Regression mdel and fit it in the training data.
4. Evaluate:Calculate the Logistic Regression model's accuracy score using the test dataset.
...
Developed by: Anish A
RegisterNumber:  212224060020
*/
...
## Output:
<img width="621" height="404" alt="image" src="https://github.com/user-attachments/assets/45c8a386-4c7e-4b95-8f8d-88da0faeac9d" />
